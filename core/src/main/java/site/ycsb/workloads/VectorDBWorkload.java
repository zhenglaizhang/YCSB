 ...
 * </ul>
 */
public class VectorDBWorkload extends Workload {
  /**
...
//    }
//    fieldlengthgenerator = VectorDBWorkload.getFieldLengthGenerator(p);
    fieldnames = new ArrayList<>();
    fieldnames.add("content_id_str");
    fieldnames.add("content_id_int");
    fieldnames.add("content_type_str");
    fieldnames.add("content_type_int");
...
//    }
  ...
  public boolean doInsert(DB db, Object threadstate) {
    ...
    String dbkey = VectorDBWorkload.buildKeyName(keynum, zeropadding, orderedinserts);
  ...
  public void doTransactionRead(DB db) {
    ...
    String keyname = VectorDBWorkload.buildKeyName(keynum, zeropadding, orderedinserts);
  ...
  public void doTransactionScan(DB db) {
    ...
    String startkeyname = VectorDBWorkload.buildKeyName(keynum, zeropadding, orderedinserts);
